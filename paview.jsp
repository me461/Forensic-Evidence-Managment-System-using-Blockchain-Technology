...
if(request.getParameter("m1")!=null){%>
    ...
    out.print("<script>alert('Report Generated..!')</script>");
}  
    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
           <li><a href="pathologyhome.jsp">Home</a></li>
                                    ...
                                    <li><a href="paview.jsp" class="selected">Collect Crime Data & Generate Report</a></li>                                    
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center>
        	      <h2><font color="white">Collect Crime Data & Generate pathology LAB Test report</font></h2>
...
  <tr>
 ...
     <th><font color="#ff8080"> FIR Id</th>
  <th><font color="#ff8080"> Location</th>
    <th><font color="#ff8080"> Description</th>
      
     
     
     <th><font color="#ff8080"> Report</th>
     
</tr>
...
<%
 ...
 while(rs.next()){
            %> <center>  <tr><td> <center><%=rs.getString(1)%></td>
                    <td> <center><%=rs.getString(2)%></td>
                    <td> <center><textarea><%=rs.getString(3)%></textarea></td>
                   
             
               
              
                <th><a href="paview1.jsp?fir=<%=rs.getString(1)%>&location=<%=rs.getString(2)%>&desc=<%=rs.getString(3)%>&bccode=<%=rs.getInt(4)%>">   click</a> </th>

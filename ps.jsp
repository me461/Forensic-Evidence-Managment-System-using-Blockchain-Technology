    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
             <li><a href="index.html" >Home</a></li>
                                    ...
                                    <li><a href="ps.jsp"class="selected">Police Station</a></li>
    ...
    <div id="templatemo_main">
        <center>
        	<h2>Police Station Login</h2>
            		<form action="psact.jsp" method="post" >

            <table>
                <tr>
                    <td align="left"><font size="4" color="white"> Station ID: </font></td><td>
                        <input type="text" align="left" placeholder="Enter ID" required size="20" name="sid"/></td>
                </tr>
                <tr></tr> <tr></tr> <tr></tr>

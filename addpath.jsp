    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
           <li><a href="adminhome.jsp" >Home</a></li>
                                    ...
                                    <li><a href="addpath.jsp" class="selected">Pathology Staff</a></li> 
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center><h1> <font color="#be7107" size="4">Add Pathology Lab </font> </h1>
               
	
                    
                 <form action="addpathact.jsp" method="post" >

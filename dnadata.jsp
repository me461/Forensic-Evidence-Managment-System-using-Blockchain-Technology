    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
            <li><a href="userhome.jsp">Home</a></li>
             <li><a href="dnadata.jsp"class="selected">DNA Data</a></li>   
                                    <li><a href="rerequest.jsp">Researcher Request</a></li>                                   
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center>
            <h2><font color="white">DNA Data</font></h2>
            <% 
...
try{ 
	...
	PreparedStatement pst=con.prepareStatement("select * from hfiles where pid = '"+id+"'");
...
<%
    ...
    while(rs.next()){
            %><tr><th><center><%=rs.getString("pid")%></th>
                <th><center><%=rs.getString("dna1")%></th>
                <th><center><%=rs.getString("dna2")%></th>
                <th><center><%=rs.getString("dna3")%></th>
        
                <th><center><%=rs.getString("dna4")%></th>

    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
            <li><a href="higherhome.jsp" >Home</a></li>
                                    ...
                                    <li><a href="hgforensic.jsp" class="selected">View Forensic report</a></li>                                    
                                    <li><a href="hddoctorreport.jsp">View Doctor Report</a></li> 
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center>
            <h2><font color="white">View Forensic report</font></h2>
           <% 


try{ 
	  Connection con = Dbconnection.getConnection();
	PreparedStatement pst=con.prepareStatement("select *  from frreport");

    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
            <li><a href="hospital1home.jsp">Home</a></li>
                                     <li><a href="fupload.jsp">File Upload</a></li>
                                    <li><a href="sendtocloud.jsp" class="selected">Send to Cloud</a></li>                                    
                                    <li><a href="viewkeys.jsp">View files</a></li>                                     
...
try{ 
	...
	PreparedStatement pst=con.prepareStatement("select * from hfiles where hospital = 'hospital1'");
...
<%
 ...
 while(rs.next()){
            %> <center>  <tr><td> <center><%=rs.getString(2)%></td>
                ...
                <th><a href="sendtocloudact.jsp?pid=<%=rs.getString("pid")%>&dna1=<%=rs.getString("dna1")%>&dna2=<%=rs.getString("dna2")%>&dna3=<%=rs.getString("dna3")%>&dna4=<%=rs.getString("dna4")%> &date=<%=rs.getString("date")%>">   Send</a> </th>

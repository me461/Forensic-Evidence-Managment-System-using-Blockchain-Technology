    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
              <li><a href="index.html">Home</a></li>
                                    ...
                                    <li><a href="ps.jsp">Police Station</a></li>
                                    <li><a href="cloud1.jsp">Forensic Staff</a></li>
                                    <li><a href="cloud2.jsp" class="selected">Pathology </a></li> 
                                    <li><a href="doctor.jsp">Doctor</a></li>  
                                    <li><a href="highe.jsp">Higher Authority</a></li>  
        </ul>
        <br style="clear: left" />
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center>
        	<h2>Pathology Login</h2>
            		<form action="C2logact.jsp" method="post" >

            <table>
                <tr>
                    <td align="left"><font size="4" color="white"> User Name: </font></td><td>
                        <input type="text" align="left" placeholder="Enter UserName" required size="20" name="username"/></td>
                </tr>
                <tr></tr> <tr></tr> <tr></tr>
                ...
                <tr>
                    <td align="right"><font size="4" color="white">Password:</font> </td><td> 
                        <input type="password" align="left" size="20" placeholder="Password" required name="password"/></td>
                </tr>
                <tr></tr> <tr></tr> <tr></tr>
                <br>

...
if(request.getParameter("m4")!=null){%>
    ...
    <script>alert('Upload Failed Patient Id is Already Registered')</script>

<%}
if(request.getParameter("dddddg")!=null){%>
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
            <li><a href="higherhome.jsp" class="selected">Home</a></li>

...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center>
        	      <h2><font color="white">Examination Based on Crime</font></h2>
 ...
     <th><font color="#ff8080"> FIR Id</th>
  <th><font color="#ff8080"> Location</th>
    <th><font color="#ff8080"> Description</th>
     ...
     <th><font color="#ff8080"> Examine</th>
     
</tr>
...
<%
 ...
 while(rs.next()){
            %> <center>  <tr><td> <center><%=rs.getString(1)%></td>
                ...
                <th><a href="dexam1.jsp?fir=<%=rs.getString(1)%>&location=<%=rs.getString(2)%>&desc=<%=rs.getString(3)%>&bccode=<%=rs.getInt(4)%>">   click</a> </th>

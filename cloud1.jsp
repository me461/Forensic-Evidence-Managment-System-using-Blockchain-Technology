    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
            <li><a href="index.html">Home</a></li>
                                    ...
                                    <li><a href="cloud1.jsp" class="selected">Forensic Staff</a></li>
                                    <li><a href="cloud2.jsp">Pathology </a></li> 
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center>
        	<h2>Forensic Login</h2>
            		<form action="forensicact.jsp" method="post" >

            <table>
                <tr>
                    <td align="left"><font size="4" color="white"> User ID </font></td><td>
                        <input type="text" align="left" placeholder="Enter ID" required size="20" name="username"/></td>
                </tr>
                <tr></tr> <tr></tr> <tr></tr>

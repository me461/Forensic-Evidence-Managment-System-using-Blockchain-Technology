...
if(request.getParameter("m1")!=null){%>
    ...
    out.print("<script>alert('Report Generated Sucessfully..!')</script>");
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
          <li><a href="pathologyhome.jsp">Home</a></li>
                                    
                                    <li><a href="paview.jsp" class="selected">Collect Crime Data & Generate LAB Report</a></li>                                    
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        ...
        String bccode = request.getParameter("bccode");
        ...
        %>
        <center><h1> <font color="#be7107" size="4">Generate LAB Report </font> </h1>
               
	
                    
                 <form action="paview2.jsp" method="post" >
			      ...
			      <table width="516" border="0" cellspacing="2" cellpadding="2">
                          ...
                          <p>&nbsp;</p>
                         <label for="name"><span class="style30">FIR</span></label>
                          <p class="style30">
                              <input id="name" required="" value="<%=fir%>" name="fir" class="text" />
                          </p>
                          <span class="style30">
                          <label for="loaction">Location </label>
                          </span>
                          <p class="style30">
                            <input type="text" required="" value="<%=location%>"  id="password" name="location" class="text" />
                          </p>
                          <span class="style30">
                          <label for="email">Description  </label>
                          </span>
                          <p class="style30">
                            <input  name="desc" value="<%=desc%>"  required="" class="text" />
                          </p>
                          <span class="style30">
                          <label for="mobile">Block Chain Code</label>
                          </span>
                         <p class="style30">
                            <input id="email" name="bccode" value="<%=bccode%>"  required="" class="text" />
                          </p>
                         <span class="style30">
                          <label for="mobile">Report</label>
                          </span>
                         
                          <p class="style30">
                            <input id="mobile" required="" name="report" class="text" />
                          </p>

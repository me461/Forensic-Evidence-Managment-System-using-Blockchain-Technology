...
if(request.getParameter("m1")!=null){%>
    ...
    out.print("<script>alert('Registration Sucessfully..!')</script>");
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center><h1> <font color="#be7107" size="4">Add Higher Officials </font> </h1>
               
	
                    
                 <form action="addhighact.jsp" method="post" >
			      ...
			      <table width="516" border="0" cellspacing="2" cellpadding="2">
                          ...
                          <p>&nbsp;</p>
                         <label for="name"><span class="style30">Username</span></label>
                          <p class="style30">
                            <input id="name" required="" name="username" class="text" />
                          </p>
                          <span class="style30">

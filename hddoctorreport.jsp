...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
            <li><a href="higherhome.jsp" >Home</a></li>
                                     <li><a href="hgviewinvest.jsp">Monitor Investigation </a></li>
                                    <li><a href="hgforensic.jsp">View Forensic report</a></li>                                    
                                    <li><a href="hddoctorreport.jsp" class="selected">View Doctor Report</a></li> 
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center>
            <h2><font color="white">View Doctor Report</font></h2>
           <% 


try{ 
	  Connection con = Dbconnection.getConnection();
	PreparedStatement pst=con.prepareStatement("select *  from doctor_report");
       
        
	ResultSet rs=pst.executeQuery();
        %>
        
        <center> <table style="width:70%" border="2">
...
<%
    ...
    while(rs.next()){
            %><tr>
                ...
                <th><center><%=rs.getString(1)%></th>
                <th><center><%=rs.getString(2)%></th>
                <th><center><%=rs.getString(3)%></th>
                 <th><center><%=rs.getString(5)%></th>

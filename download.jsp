...
<script>alert('Key Does Not Match..!')</script>
 <%
}
%>
  <%
...
  <tr>
 ...
     <th><font color="#ff8080"> Pid</th>
  <th><font color="#ff8080"> Dna1</th>
     ...
     <th><font color="#ff8080"> Download</th>
     
</tr>
...
<%
    ...
    while(rs.next()){
            %><tr><td><center><%=rs.getString("pid")%></td>
                ...
                <td><center><a href="dload.jsp?pid=<%=rs.getString("pid")%>&dna1=<%=rs.getString("dna1")%>">  Download</a> </td>

                    ...
                    while (it.hasNext()) {
                        ...
                        if (fileItem.getFieldName().equals("filename")) {
                           ...
                           date = fileItem.getString();
                            System.out.println("File Keyword" + date);
                        }
                        else if(fileItem.getFieldName().equals("name")) {
                           name = fileItem.getString();
                            System.out.println("File Keyword" + name);
                        }
                        ...
                        if (isFormField) {
                            ...
                            try {
                                ...
                                pstm = con.prepareStatement("insert into file (file,filetype, filename, CDate, data,owner,pk,mk)values(?,?,?,?,?,?,?,?)");

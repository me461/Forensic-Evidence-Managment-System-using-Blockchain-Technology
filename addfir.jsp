...
if(request.getParameter("m1")!=null){%>
    ...
    out.print("<script>alert('FIR Added Sucessfully..!')</script>");
    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
           <li><a href="pshome.jsp">Home</a></li>
                                     <li><a href="addfir.jsp" class="selected">Add FIR</a></li>
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center><h1> <font color="#be7107" size="4">Add FIR </font> </h1>
               
	
                    
                 <form action="addfiract.jsp" method="post" >
			      ...
			      <table width="516" border="0" cellspacing="2" cellpadding="2">
                          ...
                          <p>&nbsp;</p>
                         <label for="name"><span class="style30">FIR ID</span></label>
                          <p class="style30">
                            <input id="name" required="" name="fir" class="text" />
                          </p>
                         
                         <label for="name"><span class="style30">Location</span></label>
                          <p class="style30">
                            <input id="name" required="" name="location" class="text" />
                          </p>
                          <span class="style30">
                          <label for="email">Description </label>
                          </span>
                          <p class="style30">
                            <input id="email" name="desc" required="" class="text" />
                          </p>

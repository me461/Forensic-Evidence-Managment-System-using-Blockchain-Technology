    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
             <li><a href="hospital1home.jsp">Home</a></li>
                                    ...
                                    <li><a href="reviewfiles.jsp" class="selected">DNA Files</a></li> 
                                    <li><a href="download.jsp">View Data</a></li> 
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center>
            <h1><font color="white">View DNA Files</font></h1>
        	<% 
...
try{ 
	...
	PreparedStatement pst=con.prepareStatement("select distinct pid,date,dna1,dna2,dna3,dna4 from encfile");      
...
  <tr>
 ...
     <th><font color="#ff8080"> Pid</th>
  <th><font color="#ff8080"> Dna1</th>
     ...
     <th><font color="#ff8080"> Date</th>
     <th><font color="#ff8080"> Request</th>
     
</tr>
...
<%
    ...
    while(rs.next()){
            %><tr><td><center><%=rs.getString("pid")%></td>
                <td><center><%=rs.getString("dna1")%></td>
                <td><center><%=rs.getString("dna2")%></td>
                <td><center><%=rs.getString("dna3")%></td>
                <td><center><%=rs.getString("dna4")%></td>
                <td><center><%=rs.getString("date")%></td>
                <td><center><a href="request.jsp?pid=<%=rs.getString("pid")%>&dna1=<%=rs.getString("dna1")%>&dna2=<%=rs.getString("dna2")%>&dna3=<%=rs.getString("dna3")%>&dna4=<%=rs.getString("dna4")%>&date=<%=rs.getString("date")%>">  Request</a> </td>

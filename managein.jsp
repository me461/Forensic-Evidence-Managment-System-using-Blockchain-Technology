...
if(request.getParameter("m1")!=null){%>
    ...
    out.print("<script>alert('Investigation Collected  Sucessfully..!')</script>");
    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
           <li><a href="pshome.jsp">Home</a></li>
                                    ...
                                    <li><a href="managein.jsp" class="selected">Manage Investigation</a></li>                                     
...
<%@ page session="true" %>
    <div id="templatemo_main">
        <center><h1> <font color="#be7107" size="4">Manage Investigation  </font> </h1>
                 <% 
	...
	Connection con = null;
        ...
        %>
                 ...
                 <form action="manageinact.jsp" method="post" >

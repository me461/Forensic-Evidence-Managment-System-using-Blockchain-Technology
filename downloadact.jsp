                    ...
                    <center> 
                        ...
                        <br>
                            <form action="download2.jsp" method="post">
                                <b>Patient Id  :</b><input type="text" name="pid" value="<%=filedetails[0]%>" readonly=""  style="margin-left: 30px" class="textbox"/><br /><br />
                                <b>Decryption Key :</b><input type="text" name="privatekey" required="" class="textbox"/><br /><br />

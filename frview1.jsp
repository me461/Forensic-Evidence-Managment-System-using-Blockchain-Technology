...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
           <li><a href="forensichome.jsp">Home</a></li>
                                    
                                    <li><a href="frview.jsp" class="selected">Collect Crime Data & Generate Report</a></li>                                    
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        ...
        %>
        <center><h1> <font color="#be7107" size="4">Generate Report </font> </h1>
               
	
                    
                 <form action="frview2.jsp" method="post" >

...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
            <li><a href="pathologyhome.jsp" class="selected">Home</a></li>
                                      <li><a href="paview.jsp">Collect Crime Data & Generate Report</a></li> 
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center>
            <h2><font color="white">Welcome to Pathology LAB</font></h2>
            		  </center> 
          <div class="cleaner"></div>
         <!-- end of content -->

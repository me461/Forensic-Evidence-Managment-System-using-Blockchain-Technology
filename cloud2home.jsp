...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
           <li><a href="cloud2home.jsp" class="selected">Home</a></li>
                                    <li><a href="viewresaerch.jsp">View Researchers</a></li>
                             
                                    <li><a href="viewresaerchfiles.jsp">View files</a></li> 
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center>
            <h2><font color="white">Welcome Cloud2</font></h2>
            		  </center> 
          <div class="cleaner"></div>
         <!-- end of content -->

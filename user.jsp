...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
                                    ...
                                    <li><a href="user.jsp" class="selected">User</a></li>  
        </ul>
        <br style="clear: left" />
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center>
        	<h2>User Login</h2>
            		<form action="userlogact.jsp" method="post" >

            <table>
                <tr>
                    <td align="left"><font size="4" color="white"> User Name: </font></td><td>
                        <input type="text" align="left" placeholder="Enter UserName" required size="20" name="id"/></td>
                </tr>
                <tr></tr> <tr></tr> <tr></tr>

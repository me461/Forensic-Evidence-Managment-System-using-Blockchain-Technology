    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
            <li><a href="higherhome.jsp" >Home</a></li>
                                     <li><a href="hgviewinvest.jsp" class="selected">Monitor Investigation </a></li>
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center>
            <h2><font color="white">View Investigation Based on Police Station </font></h2>
           <% 
...
  <tr>
    ...
     
         <th><font color="#ff8080">Police Station ID</th>

...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center>
        	      <h2><font color="white">Collect Crime Data & Generate Report</font></h2>
...
<%
 ...
 while(rs.next()){
            %> <center>  <tr><td> <center><%=rs.getString(1)%></td>
                ...
                <th><a href="frview1.jsp?fir=<%=rs.getString(1)%>&location=<%=rs.getString(2)%>&desc=<%=rs.getString(3)%>&bccode=<%=rs.getInt(4)%>">   click</a> </th>

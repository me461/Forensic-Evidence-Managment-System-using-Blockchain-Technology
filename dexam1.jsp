    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
         <li><a href="doctorhome.jsp" >Home</a></li>
                                    ...
                                    <li><a href="dexam.jsp"class="selected">Examination & Generate Report</a></li> 
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        ...
        %>
        <center><h1> <font color="#be7107" size="4">Examination Report </font> </h1>
               
	
                    
                 <form action="dexam2.jsp" method="post" >
